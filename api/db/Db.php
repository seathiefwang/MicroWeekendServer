...
class Db
{
    public static $mysql_username     = "root"; //用户名
    public static $mysql_password     = "199110241129"; // 用户密码
    public static $mysql_database     = "microweekend"; // 数据库名
    public static $mysql_server_name  = "localhost"; // 数据库地址ַ
